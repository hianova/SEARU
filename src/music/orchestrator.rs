...
impl Orchestrator {
    ...
    pub fn evaluate_macro_curves(
        bars: usize,
        energy_curve: &[f64],
    ) -> (Vec<f32>, Vec<f32>, Vec<f64>, Vec<bool>) {
    ...
    pub fn orchestrate_track(
        ...
        for i in 1..phrase_len {
            ...
            let (next_chord, _) =
                EvolutionaryComposer::discover_bach_progression(&chord_loop, target_diss);
