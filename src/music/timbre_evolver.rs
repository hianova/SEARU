...
impl TimbreEvolver {
    ...
    pub fn evolve_instrument(inst_type: InstrumentType) -> TimbreProfile {
        ...
        genes.push(Gene {
            ...
            bounds: attack_bounds,
            current_value: attack_bounds.0,
        });
        genes.push(Gene {
            name: "decay".to_string(),
            bounds: decay_bounds,
            current_value: decay_bounds.0,
        });
        genes.push(Gene {
            name: "sustain".to_string(),
            bounds: sustain_bounds,
            current_value: sustain_bounds.0,
        });
        genes.push(Gene {
            name: "release".to_string(),
            bounds: release_bounds,
            current_value: release_bounds.0,
        });
