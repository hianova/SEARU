use no_std_tool::structures::compress::{
    CompressError, leb128_decode_u32, leb128_encode_u32, zigzag_decode_u32, zigzag_encode_i32,
};
...
mod tests {
    ...
    fn test_vec_time_series_encoder() {
        ...
        let size = encoder.encode_block_8(&input, &mut compressed).unwrap();
