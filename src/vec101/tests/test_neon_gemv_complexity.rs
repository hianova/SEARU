...
fn test_neon_gemv_complexity() {
    ...
    let x_stream = unsafe { &mut X_STREAM[..blocks_per_row * 2048 * padded_batch] };
    let s_stream = unsafe { &mut S_STREAM[..] };
    ...
    unsafe {
        ...
        vec101::compute::simd::neon::process_row_neon_gemm(
            0,
            &ctx,
            x_stream,
            &x_mask,
        ...
        vec101::compute::simd::scalar::process_row_scalar_gemm(
            0,
            &ctx,
            x_stream,
            &x_mask,
