...
fn test_adversarial_invalid_urls() {
    ...
    ctx.http_mock_routes
        .insert("https://valid.route".to_string(), "OK".to_string());
    ...
    // 3. Empty string URL
    vm.pc = 0;
    vm.write_string(covopt_param!("M_50_20", 100), "", true)
        .unwrap();
    ...
    vm.pc = 0;
    vm.write_bytes(
        covopt_param!("M_67_19", 200),
        &[
            covopt_param!("M_67_26", 255),
            covopt_param!("M_67_31", 254),
            covopt_param!("M_67_36", 253),
            0x00,
        ],
    )
    .unwrap();
...
fn test_adversarial_invalid_file_paths() {
    let mut vm = ScriptVm::new();
    let mut ctx = HostContext::new();
    ctx.virtual_filesystem
        .insert("secret.txt".to_string(), b"topsecret".to_vec());
    vm.register_host_context(ctx);
    vm.register_sgl_io();
    ...
    vm.pc = 0;
    vm.write_string(covopt_param!("M_140_20", 100), "nonexistent.txt", true)
        .unwrap();
    ...
    vm.pc = 0;
    vm.write_string(covopt_param!("M_154_20", 100), "", true)
        .unwrap();
...
fn test_adversarial_file_write_out_of_bounds() {
    ...
    vm.write_string(covopt_param!("M_185_20", 100), "overflow.txt", true)
        .unwrap();
...
fn test_adversarial_zero_length_strings() {
    ...
    vm.write_string(covopt_param!("M_215_20", 100), "", true)
        .unwrap();
    vm.write_string(covopt_param!("M_216_20", 200), "", true)
        .unwrap();
    ...
    let code2 = [
        Instruction::new(
            ...
            covopt_param!("M_239_48", 10),
            covopt_param!("M_239_52", 11),
            covopt_param!("M_239_56", 12),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    let res2 = vm.run(&code2);
    ...
    let code3 = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_252_48", 20),
            covopt_param!("M_252_52", 21),
            covopt_param!("M_252_56", 22),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    let res3 = vm.run(&code3);
...
fn test_adversarial_out_of_bounds_slice_indices() {
    ...
    vm.write_string(covopt_param!("M_276_20", 100), sample_str, true)
        .unwrap();
    ...
    let code2 = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_305_48", 10),
            covopt_param!("M_305_52", 11),
            covopt_param!("M_305_56", 12),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    let res2 = vm.run(&code2);
    ...
    let code3 = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_323_48", 20),
            covopt_param!("M_323_52", 21),
            covopt_param!("M_323_56", 22),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    let res3 = vm.run(&code3);
    ...
    assert_eq!(
        string_slice(&mut vm, unicode_str.to_string(), 2, 10),
        "ScriptGo"
    );
    assert_eq!(
        string_slice(&mut vm, unicode_str.to_string(), 10, 12),
        "🔥⚡"
    );
...
fn test_adversarial_closed_and_invalid_sockets() {
    ...
    vm.write_bytes(covopt_param!("M_349_19", 100), b"data_to_send")
        .unwrap();
    ...
    let code2 = [
        Instruction::new(
            OpCode::HardwareCall as u8,
            covopt_param!("M_374_53", 10),
            covopt_param!("M_374_57", 11),
            covopt_param!("M_374_61", 12),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    let res2 = vm.run(&code2);
...
fn test_adversarial_invalid_registers_and_wrapping() {
    ...
    vm.write_string(covopt_param!("M_401_20", 100), "wrapping.txt", true)
        .unwrap();
    vm.write_bytes(covopt_param!("M_402_19", 200), b"wrapping_data")
        .unwrap();
    ...
    let code1 = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_411_48", 10),
            covopt_param!("M_411_52", 11),
            covopt_param!("M_411_56", 255),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    let res1 = vm.run(&code1);
    ...
    let code2 = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_428_48", 20),
            covopt_param!("M_428_52", 21),
            covopt_param!("M_428_56", 22),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    let res2 = vm.run(&code2);
    ...
    let code3 = [
        Instruction::new(
            OpCode::HardwareCall as u8,
            covopt_param!("M_441_53", 30),
            covopt_param!("M_441_57", 31),
            covopt_param!("M_441_61", 32),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    let res3 = vm.run(&code3);
...
fn test_adversarial_environment_variables() {
    ...
    assert_eq!(
        get_env(&mut vm, "USER".to_string()),
        Ok("sgl_runner".to_string())
    );
}
