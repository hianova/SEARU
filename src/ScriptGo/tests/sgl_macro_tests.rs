...
fn test_sgl_package_registration_and_invocation() {
    ...
    vm.write_string(covopt_param!("M_66_20", 100), url, true)
        .unwrap();
...
fn test_host_no_panic_catch_unwind_on_panic() {
    ...
    vm.write_string(covopt_param!("M_118_20", 100), "trigger_panic", true)
        .unwrap();
...
fn test_sgl_combine_handlers() {
    ...
    vm.write_string(covopt_param!("M_146_20", 100), "127.0.0.1:8080", true)
        .unwrap();
    vm.registers[1] = 0;
    ...
    vm.write_string(covopt_param!("M_159_20", 200), "/etc/config", true)
        .unwrap();
    ...
    let inst2 = Instruction::new(
        OpCode::HardwareCall as u8,
        covopt_param!("M_164_61", 4),
        covopt_param!("M_164_64", 5),
        covopt_param!("M_164_67", 6),
    );
...
fn test_standalone_hardware_call() {
    ...
    vm.write_string(covopt_param!("M_178_20", 100), "hello", true)
        .unwrap();
    vm.registers[1] = 0;
