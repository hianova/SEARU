...
fn test_sgl_net_http_get_mock_route() {
    ...
    vm.write_string(covopt_param!("M_23_20", 100), url, true)
        .unwrap();
...
fn test_sgl_net_http_get_default_response() {
    ...
    vm.write_string(covopt_param!("M_49_20", 100), url, true)
        .unwrap();
...
fn test_sgl_net_http_post() {
    ...
    vm.write_string(covopt_param!("M_77_20", 100), url, true)
        .unwrap();
    vm.write_string(covopt_param!("M_78_20", 200), body, true)
        .unwrap();
...
fn test_sgl_net_socket_lifecycle() {
    ...
    vm.write_string(covopt_param!("M_109_20", 100), addr, true)
        .unwrap();
    ...
    let inst_connect = Instruction::new(
        OpCode::HardwareCall as u8,
        1,
        2,
        covopt_param!("M_115_74", 3),
    );
    ...
    vm.write_bytes(covopt_param!("M_125_19", 200), payload)
        .unwrap();
    ...
    let inst_send = Instruction::new(
        OpCode::HardwareCall as u8,
        covopt_param!("M_134_65", 10),
        covopt_param!("M_134_69", 11),
        covopt_param!("M_134_73", 12),
    );
    ...
    let inst_recv = Instruction::new(
        OpCode::HardwareCall as u8,
        covopt_param!("M_168_65", 20),
        covopt_param!("M_168_69", 21),
        covopt_param!("M_168_73", 22),
    );
    ...
    let recv_data = vm
        .read_bytes(
            covopt_param!("M_175_34", 300),
            covopt_param!("M_175_39", 10),
            false,
        )
        .unwrap();
...
fn test_sgl_io_file_read_and_write() {
    ...
    vm.write_string(covopt_param!("M_206_20", 100), file_path, true)
        .unwrap();
    ...
    vm.write_string(covopt_param!("M_226_20", 200), new_file, true)
        .unwrap();
    vm.write_bytes(covopt_param!("M_227_19", 300), data)
        .unwrap();
    ...
    let inst_write = Instruction::new(
        OpCode::SysCall as u8,
        covopt_param!("M_236_61", 10),
        covopt_param!("M_236_65", 11),
        covopt_param!("M_236_69", 12),
    );
    ...
    let inst_read2 = Instruction::new(
        OpCode::SysCall as u8,
        covopt_param!("M_249_61", 20),
        covopt_param!("M_249_65", 21),
        covopt_param!("M_249_69", 22),
    );
...
fn test_sgl_io_system_and_env() {
    ...
    // 2. GetEnv "ENV"
    vm.write_string(covopt_param!("M_279_20", 100), "ENV", true)
        .unwrap();
    ...
    let inst_env = Instruction::new(
        OpCode::SysCall as u8,
        covopt_param!("M_286_59", 10),
        covopt_param!("M_286_63", 11),
        covopt_param!("M_286_67", 12),
    );
...
fn test_sgl_io_string_utilities() {
    ...
    vm.write_string(covopt_param!("M_305_20", 100), "Hello", true)
        .unwrap();
    vm.write_string(covopt_param!("M_306_20", 200), " World", true)
        .unwrap();
    ...
    let inst_len = Instruction::new(
        OpCode::SysCall as u8,
        covopt_param!("M_328_59", 10),
        covopt_param!("M_328_63", 11),
        covopt_param!("M_328_67", 12),
    );
    ...
    let inst_slice = Instruction::new(
        OpCode::SysCall as u8,
        covopt_param!("M_343_61", 20),
        covopt_param!("M_343_65", 21),
        covopt_param!("M_343_69", 22),
    );
    ...
    let inst_upper = Instruction::new(
        OpCode::SysCall as u8,
        covopt_param!("M_358_61", 30),
        covopt_param!("M_358_65", 31),
        covopt_param!("M_358_69", 32),
    );
    ...
    let inst_lower = Instruction::new(
        OpCode::SysCall as u8,
        covopt_param!("M_373_61", 40),
        covopt_param!("M_373_65", 41),
        covopt_param!("M_373_69", 42),
    );
...
fn test_sgl_net_and_io_combined_script_execution() {
    ...
    vm.write_string(covopt_param!("M_396_20", 100), "test.txt", true)
        .unwrap();
    vm.write_string(
        covopt_param!("M_397_20", 200),
        "https://api.sgl.internal/status",
        true,
    )
    .unwrap();
    ...
    let code = [
        ...
        Instruction::new(
            OpCode::HardwareCall as u8,
            covopt_param!("M_417_53", 4),
            covopt_param!("M_417_56", 5),
            covopt_param!("M_417_59", 6),
        ),
    ...
    assert_eq!(
        http_response,
        r#"{"status":"online","service":"sgl-runtime"}"#
    );
    ...
    let concat_code = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_444_48", 7),
            covopt_param!("M_444_51", 8),
            covopt_param!("M_444_54", 9),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
...
fn test_invalid_address_safety_guarantee() {
    ...
    let inst2 = Instruction::new(
        OpCode::SysCall as u8,
        covopt_param!("M_484_56", 10),
        covopt_param!("M_484_60", 11),
        covopt_param!("M_484_64", 12),
    );
