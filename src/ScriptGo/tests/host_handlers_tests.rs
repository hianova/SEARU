...
fn test_vm_memory_payload_helpers() {
    ...
    let bytes_written = vm
        .write_string(covopt_param!("M_16_40", 64), sample_text, true)
        .unwrap();
    ...
    let raw_payload: [u8; 5] = [
        covopt_param!("M_23_32", 10),
        covopt_param!("M_23_36", 20),
        covopt_param!("M_23_40", 30),
        covopt_param!("M_23_44", 40),
        covopt_param!("M_23_48", 50),
    ];
    vm.write_bytes(covopt_param!("M_24_19", 128), &raw_payload)
        .unwrap();
    let read_payload = vm
        .read_bytes(
            covopt_param!("M_25_37", 128),
            covopt_param!("M_25_42", 5),
            false,
        )
        .unwrap();
...
fn test_networking_handlers() {
    ...
    let code_net_status = [
        Instruction::new(
            ...
            1,
            covopt_param!("M_43_56", 6),
            covopt_param!("M_43_59", 6),
        ),
    ...
    vm.write_string(covopt_param!("M_76_20", 200), post_url, true)
        .unwrap();
    vm.write_string(covopt_param!("M_77_20", 250), post_body, true)
        .unwrap();
    ...
    let code_http_post = [
        Instruction::new(
            OpCode::HardwareCall as u8,
            covopt_param!("M_81_53", 4),
            2,
            covopt_param!("M_81_59", 10),
        ), // R[4] = HttpPost(url: R[10], body: R[11])
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    vm.pc = 0;
    ...
    vm.write_string(covopt_param!("M_93_20", 300), socket_addr, true)
        .unwrap();
    vm.registers[covopt_param!("M_94_17", 12)] = covopt_param!("M_94_23", 300);
    let code_socket_connect = [
        Instruction::new(
            OpCode::HardwareCall as u8,
            covopt_param!("M_96_53", 5),
            covopt_param!("M_96_56", 3),
            covopt_param!("M_96_59", 12),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    vm.pc = 0;
    ...
    vm.write_string(covopt_param!("M_106_20", 350), send_data, false)
        .unwrap();
    ...
    let code_socket_send = [
        Instruction::new(
            OpCode::HardwareCall as u8,
            covopt_param!("M_111_53", 6),
            covopt_param!("M_111_56", 4),
            covopt_param!("M_111_59", 13),
        ), // Cmd 4 = SocketSend
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    vm.pc = 0;
...
fn test_file_and_system_io_handlers() {
    ...
    // 2. Test GetEnv (Cmd 4)
    vm.write_string(covopt_param!("M_136_20", 100), "ENV", true)
        .unwrap();
    vm.registers[covopt_param!("M_137_17", 3)] = SysCallCommand::GetEnv as u32;
    let code_getenv = [
        Instruction::new(
            OpCode::LoadImm as u8,
            covopt_param!("M_139_48", 4),
            covopt_param!("M_139_51", 100),
            0,
        ),
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_140_48", 5),
            covopt_param!("M_140_51", 3),
            covopt_param!("M_140_54", 4),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    vm.pc = 0;
    ...
    vm.write_string(covopt_param!("M_153_20", 200), file_path, true)
        .unwrap();
    vm.write_string(covopt_param!("M_154_20", 250), file_content, false)
        .unwrap();
    ...
    let code_file_write = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_162_48", 6),
            covopt_param!("M_162_51", 10),
            covopt_param!("M_162_55", 11),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    vm.pc = 0;
    ...
    let code_file_read = [
        Instruction::new(
            OpCode::LoadImm as u8,
            covopt_param!("M_172_48", 21),
            covopt_param!("M_172_52", 200),
            0,
        ),
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_173_48", 7),
            covopt_param!("M_173_51", 20),
            covopt_param!("M_173_55", 21),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    vm.pc = 0;
...
fn test_string_manipulation_handlers() {
    ...
    vm.write_string(covopt_param!("M_192_20", 100), str1, true)
        .unwrap();
    vm.write_string(covopt_param!("M_193_20", 150), str2, true)
        .unwrap();
    ...
    let code_length = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_211_48", 11),
            covopt_param!("M_211_52", 4),
            covopt_param!("M_211_55", 10),
    ...
    vm.write_string(covopt_param!("M_220_20", 200), full_string, true)
        .unwrap();
    ...
    let code_slice = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_226_48", 12),
            covopt_param!("M_226_52", 5),
            covopt_param!("M_226_55", 6),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    vm.pc = 0;
    ...
    let code_upper = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_239_48", 13),
            covopt_param!("M_239_52", 15),
            covopt_param!("M_239_56", 16),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    vm.pc = 0;
    ...
    let code_lower = [
        Instruction::new(
            OpCode::SysCall as u8,
            covopt_param!("M_251_48", 14),
            covopt_param!("M_251_52", 17),
            covopt_param!("M_251_56", 18),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
    vm.pc = 0;
...
fn test_sgo_sample_scripts_execution() {
    ...
    vm.write_string(covopt_param!("M_272_20", 30), "Part1", true)
        .unwrap();
    vm.write_string(covopt_param!("M_273_20", 40), "Part2", true)
        .unwrap();
