...
fn test_memory_load_store() {
    ...
    let code = [
        ...
        Instruction::new(
            OpCode::Load as u8,
            covopt_param!("M_107_49", 4),
            2,
            covopt_param!("M_107_55", 3),
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
...
fn test_math_approximations() {
    ...
    let code = [
        ...
        Instruction::new(
            OpCode::Silu as u8,
            covopt_param!("M_137_49", 6),
            covopt_param!("M_137_52", 3),
            0,
        ),
        Instruction::new(OpCode::Halt as u8, 0, 0, 0),
    ];
...
fn test_audit() {
        ...
        let handle = std::thread::spawn(move || {
            ...
            let code = [
                ...
                Instruction::new(
                    ...
                    covopt_param!("M_323_62", 4),
                    0,
                    covopt_param!("M_323_68", 5),
                ),
    ...
    for _ in 0..covopt_param!("M_357_20", 4) {
        rx.recv_timeout(std::time::Duration::from_secs(covopt_param!("M_358_59", 5)))
    ...
    let code_mem = [
        Instruction::new(
            OpCode::LoadImm16 as u8,
            1,
            (covopt_param!("M_387_58", 10000) & covopt_param!("M_387_66", 255)) as u8,
            (covopt_param!("M_387_79", 10000) >> covopt_param!("M_387_88", 8)) as u8,
        ),
    ...
    let code_store = [
        Instruction::new(
            OpCode::LoadImm16 as u8,
            1,
            (covopt_param!("M_461_58", 10000) & covopt_param!("M_461_66", 255)) as u8,
            (covopt_param!("M_461_79", 10000) >> covopt_param!("M_461_88", 8)) as u8,
        ),
...
fn test_compiler_vm_execution_and_ui_call() {
    ...
    assert!(
        UI_CALLED.load(Ordering::SeqCst),
        "ui_handler was not called by ui_call instruction"
    );
}
