...
impl HostContext {
    pub fn new() -> Self {
        ...
        context
            .environment_variables
            .insert("USER".to_string(), "sgl_runner".to_string());
    ...
    fn handle_file_write(&mut self, vm: &mut ScriptVm, dest_reg: usize, arg_reg: usize) {
        ...
        let data_address =
            vm.registers[arg_reg.wrapping_add(1) % covopt_param!("M_258_66", 256)] as usize;
        let data_length =
            vm.registers[arg_reg.wrapping_add(2) % covopt_param!("M_259_65", 256)] as usize;
    ...
    fn handle_get_timestamp(&mut self, vm: &mut ScriptVm, dest_reg: usize) {
        ...
        vm.registers[dest_reg] =
            (self.timestamp_counter & covopt_param!("M_279_59", 4294967295)) as u32;
    }
    ...
    fn handle_string_concat(&mut self, vm: &mut ScriptVm, dest_reg: usize, arg_reg: usize) {
        ...
        let str2_addr =
            if second_reg < covopt_param!("M_311_40", 256) && vm.registers[second_reg] > 0 {
    ...
    fn handle_string_length(&mut self, vm: &mut ScriptVm, dest_reg: usize, str_ptr_reg: usize) {
        let str_addr =
            if str_ptr_reg < covopt_param!("M_333_40", 256) && vm.registers[str_ptr_reg] > 0 {
    ...
    fn handle_string_to_upper(&mut self, vm: &mut ScriptVm, dest_reg: usize, str_ptr_reg: usize) {
        let str_addr =
            if str_ptr_reg < covopt_param!("M_374_40", 256) && vm.registers[str_ptr_reg] > 0 {
                vm.registers[str_ptr_reg] as usize
            } else {
                str_ptr_reg
            };
    ...
    fn handle_string_to_lower(&mut self, vm: &mut ScriptVm, dest_reg: usize, str_ptr_reg: usize) {
        let str_addr =
            if str_ptr_reg < covopt_param!("M_392_40", 256) && vm.registers[str_ptr_reg] > 0 {
                vm.registers[str_ptr_reg] as usize
            } else {
                str_ptr_reg
            };
    ...
    fn handle_http_get(&mut self, vm: &mut ScriptVm, dest_reg: usize, url_ptr_reg: usize) {
        let url_addr =
            if url_ptr_reg < covopt_param!("M_412_40", 256) && vm.registers[url_ptr_reg] > 0 {
    ...
    fn handle_socket_send(&mut self, vm: &mut ScriptVm, dest_reg: usize, arg_reg: usize) {
        let socket_id = if arg_reg < covopt_param!("M_497_37", 256) {
            vm.registers[arg_reg]
        } else {
            arg_reg as u32
        };
        ...
        let bytes = vm
            .read_bytes(buf_addr, buf_len, buf_len == 0)
            .unwrap_or_default();
    ...
    fn handle_socket_recv(&mut self, vm: &mut ScriptVm, dest_reg: usize, arg_reg: usize) {
        let socket_id = if arg_reg < covopt_param!("M_515_37", 256) {
            vm.registers[arg_reg]
        } else {
            arg_reg as u32
        };
