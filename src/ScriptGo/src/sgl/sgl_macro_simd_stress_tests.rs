...
mod tests {
    ...
    fn test_sgl_macro_invalid_utf8_string() {
        ...
        let invalid_utf8_bytes: [u8; 5] = [
            covopt_param!("M_97_43", 255),
            covopt_param!("M_97_48", 254),
            covopt_param!("M_97_53", 253),
            covopt_param!("M_97_58", 128),
            0x00,
        ];
    ...
    fn test_sgl_macro_multi_args_invalid_inputs() {
        ...
        vm.write_bytes(covopt_param!("M_162_23", 100), valid_str.as_bytes())
            .unwrap();
    ...
    fn test_simd_integer_overflow_length_usize_max() {
        ...
        // OpCode 39 (VecAdd)
        let code_add = [Instruction::new(
            OpCode::VecAdd as u8,
            1,
            2,
            covopt_param!("M_192_69", 3),
        )];
        ...
        // OpCode 40 (VecMul)
        vm.pc = 0;
        let code_mul = [Instruction::new(
            OpCode::VecMul as u8,
            1,
            2,
            covopt_param!("M_203_69", 3),
        )];
        ...
        // OpCode 41 (VecDot)
        vm.pc = 0;
        let code_dot = [Instruction::new(
            OpCode::VecDot as u8,
            1,
            2,
            covopt_param!("M_214_69", 3),
        )];
    ...
    fn test_simd_invalid_vm_addresses_0xdeadbeef() {
        ...
        let code1 = [Instruction::new(
            OpCode::VecAdd as u8,
            1,
            2,
            covopt_param!("M_264_66", 3),
        )];
        ...
        let code2 = [Instruction::new(
            OpCode::VecMul as u8,
            1,
            2,
            covopt_param!("M_276_66", 3),
        )];
        ...
        let code3 = [Instruction::new(
            OpCode::VecDot as u8,
            1,
            2,
            covopt_param!("M_288_66", 3),
        )];
    ...
    fn test_simd_out_of_bounds_ram_address() {
        ...
        assert!(
            matches!(
                res,
                Err(VmError::MemoryAccessOutOfBounds { addr: 1000, .. })
            ),
