...
impl TypographyGenerator {
    pub fn generate_glyph() -> Glyph {
        ...
        genes.push(Gene { name: "P1_X".to_string(), bounds: (0.0, 100.0), current_value: 50.0 });
        genes.push(Gene { name: "P1_Y".to_string(), bounds: (0.0, 100.0), current_value: 50.0 });
        genes.push(Gene { name: "P2_X".to_string(), bounds: (0.0, 100.0), current_value: 50.0 });
        genes.push(Gene { name: "P2_Y".to_string(), bounds: (0.0, 100.0), current_value: 50.0 });
    ...
    pub fn to_svg_string(glyph: &Glyph) -> String {
        format!(
            ...
            glyph.p0.0, glyph.p0.1, glyph.p1.0, glyph.p1.1, glyph.p2.0, glyph.p2.1, glyph.p3.0, glyph.p3.1
        )
    }
}
