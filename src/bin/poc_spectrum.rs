    ...
    for (i, sample) in track.iter_mut().enumerate() {
        ...
        for &freq in chord_freqs {
            ...
            for h in 1..=num_harmonics {
                ...
                note_audio +=
                    (harmonic_freq * detune * t * std::f64::consts::TAU).sin() * amplitude;
            }
            mixed += note_audio;
        }
